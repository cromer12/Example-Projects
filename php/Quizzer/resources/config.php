...
defined("DB_USER") ? null : define("DB_USER", "id2681202_cromer123");  //may need to change that to \

defined("DB_PASS") ? null : define("DB_PASS", "cromer12");  //may need to change that to \

defined("DB_NAME") ? null : define("DB_NAME", "id2681202_website");  //may need to change that to \
